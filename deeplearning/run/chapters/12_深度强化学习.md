...
![](images/5d1964aabff59258505f6c678ba72e0b7eb851595953bd59e36c58ff0c6c813c.jpg)（描述：示意图，展示智能体与环境之间的交互过程，包含状态、动作和奖励的循环关系）  
图 12.2 智能体与环境的交互
...
![](images/e12443a5d24770726d1ad5c7d7d68a661ec57ea7b87fa199e96fbce6bf453e89.jpg)（描述：马尔可夫决策过程的状态-动作序列示意图，展示状态s和动作a在时间步上的转移关系）  
图 12.3 马尔可夫决策过程
...
![](images/af7710199723e537a33f8a1c3ae878fd17431ec0b8f3bf333692118e766a4456.jpg)（描述：该图为TRPO算法中策略更新的示意图，展示了旧策略与新策略之间的比率关系，用于说明优化过程中的重要性采样机制。）
...
![](images/9b6d394ad37bf0e8da59866817b8c9c74db04768848083526068741bf9424453.jpg)（描述：强化学习算法分类的层次结构图，展示策略搜索与值函数估计两大分支及其子方法）  
图12.4 不同强化学习算法之间的关系
