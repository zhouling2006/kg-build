...
![](images/edb00df9c88d0c515a93fa59046ba94956006280dd992a9596ef7a0efbf35871.jpg)（描述：软性注意力机制的结构图，展示查询q与输入序列x1到xT通过softmax计算注意力权重α1到αT，并加权求和得到输出a）  
(a) 普通模式

![](images/54dea11883f6d68f1c358c267ad8a30924d3c91b40ce609a93fc49b8e6e48d74.jpg)（描述：注意力机制的结构示意图，展示了查询q与多个键k和值v之间的计算流程，包含softmax操作和加权求和过程）  
(b) 键值对模式  
图 8.1 注意力机制
...
![](images/6d60d9a2a481228e27247bb1421095841d3a40590debe8f9a430e7a785d80249.jpg)（描述：指针网络的结构示意图，展示了编码器和解码器之间的连接关系以及输入数字经过循环神经网络后的隐状态）  
图 8.2 指针网络
...
![](images/0472f2ca275f35df722c9c1f4e024d805290abaed942fa9d7d2c6d5379412886.jpg)（描述：示意图，展示卷积网络和双向循环网络对变长序列的编码方式，包含输入向量x和隐藏状态h的结构关系）  
...
![](images/5dfe7764a2b0c5f15faa8b70d810769b3c5757a8f8bef9900e019cc2c9634da3.jpg)（描述：自注意力机制的计算流程图，展示了输入序列通过查询、键、值矩阵变换后计算注意力权重并生成输出的过程）  
图 8.4 自注意力模型的计算过程
...
![](images/e88afc4a489bd3b9489ce06719eae49a4ff604635bfb0fa2f0c9d2e450db9d0b.jpg)（描述：自注意力层的结构图，展示输入序列x1到x5与隐藏状态h1到h5之间的动态连接关系）  
(a) 全连接层

![](images/6262699e69cb90cc248ce7aa1cd865df6b442e64820b1f89359e54ac76397f51.jpg)（描述：示意图，展示自注意力层中输入序列x1到x5与隐藏状态h1到h5之间的注意力权重连接关系）  
(b) 自注意力层  
图8.5 全连接层和自注意力层
...
![](images/258bdfa5a703e8eb69129bc2460994be04d9de3c8d1574cba3806f3f2437b042.jpg)（描述：Transformer网络结构示意图，展示了编码器和解码器的组成模块，包括自注意力、前馈网络、加与规范化等组件）  
...
![](images/0e9db573e69839c35c6048f948f3c3e5bd4d2ceb2953876aa8c4fa6aa06075dd.jpg)（描述：示意图，展示旋转位置编码（RoPE）中通过二维旋转矩阵对查询和键向量进行位置编码的机制）
...
![](images/0526aaea29d31ae935533e8a1ca760bcec03e666c32c12df41e55f5a7623fc69.jpg)（描述：示意图，展示了绝对位置编码、相对位置编码和RoPE三种位置编码方法的结构差异）  
图 8.8 三种不同的位置编码
...
![](images/4cc0faf3bc267b96d51f8bcad460bf624e82baf13f947a7c13fb9f30ed0743fc.jpg)（描述：流程图，展示了三种典型Transformer架构的信息流：仅编码器、仅解码器和编码器-解码器结构）  
...
![](images/20c03935e8707e44c35170f1b981f23bfd827d9e8e582442ce29c7cfdd69404c.jpg)（描述：结构图，展示了现代Transformer优化的四个主要方向及其关键技术）  
...
![](images/219fafec823286304da32bc23bc808e2655da9d4291937c13ece597869ac1f5a.jpg)（描述：Transformer块的结构示意图，展示自注意力、残差相加、LayerNorm和FFN等组件的层级关系）  
(a) 原始 Transformer块

![](images/5a3dbccc31873e51653bdea85027532a1b1f0df929d8a69506cbe1b02f4a0a6c.jpg)（描述：流程图，展示现代Transformer块的典型结构，包含RMSNorm、注意力机制、残差相加和SwiGLU FFN等组件）  
(b) 现代 Transformer块  
...
![](images/1f1739ddc41bdea46d81ca627dfb76142652cda607bef3e0aa594724e7c82be6.jpg)（描述：流程图，展示前缀填充和解码阶段中KV缓存的使用过程，包含迭代计算与缓存读写关系）  
...
![](images/8e1fdfad74227fe4a1152891a2f7c9f4ce68072c4f4fdb0cb64c5ecad452df8d.jpg)（描述：结构图，展示了标准多头注意力机制中查询Q与键K、值V的对应关系）  
(a) 标准多头注意力

![](images/80b6e7b7ba797f2bab3bf2e2aa495cca78d1415a8d1613771020f8b7621f444d.jpg)（描述：示意图，展示分组查询注意力机制中四个查询Q1至Q4分别对应两个键值对K1,V1和K2,V2的映射关系）  
(b) 分组查询注意力  
